...
bool f$date_default_timezone_set(const string &s) {
  if (strcmp(s.c_str(), "Etc/GMT-3") == 0) {
    set_default_timezone_id("Etc/GMT-3");
    return true;
  }
  if (strcmp(s.c_str(), "Europe/Moscow") == 0) {
    set_default_timezone_id("Europe/Moscow");
    return true;
  }
  // TODO: this branch is weird; remove it?
  if (strcmp(s.c_str(), "Etc/GMT-4") == 0) {
